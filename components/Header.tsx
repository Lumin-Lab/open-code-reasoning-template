  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-white/10 px-6 py-3 shadow-sm bg-[#252932]">
      <div className="flex items-center gap-4 text-[#E0E0E0]">
        <div className="size-6 text-[#9F70FD]">
        ...
        <h2 className="text-lg font-bold leading-tight tracking-[-0.015em] font-display">AI Coding Debate</h2>
        
        <button 
          onClick={onOpenTopics}
          className="ml-4 px-3 py-1.5 rounded-md bg-white/5 hover:bg-white/10 border border-white/10 text-sm font-medium transition-colors flex items-center gap-2"
        >
